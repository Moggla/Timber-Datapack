...
execute if score not_vanilla timber matches 1 run tellraw @a[tag=!noTimberWarning] ["",{text:"Timber Datapack Warning: ",color:"red"},{text:"Compatibility in non-vanilla servers is not guaranteed! For more information please visit official download site.",click_event:{action:"open_url",url:"https://github.com/Moggla/Timber-Datapack"}}]