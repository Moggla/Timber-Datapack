...
2. Update the version string in `data/timber/dialog/help.json` (pause menu) and `data/timber/function/settings/open/help.mcfunction` (the same help dialog, opened by commands).
