...
await delay 1s
function timber_test:count_d7 {test:"settings_axe_netherite_chops"}
function timber_test:player {name:"ax_nether_t",axe:"minecraft:netherite_axe"}
dummy ax_nether_t mine ~20 ~0 ~20
...
function timber_test:assert_no_tree {test:"settings_axe_netherite_chops"}
