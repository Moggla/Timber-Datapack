#> With the iron axe switched off it doesn't chop
...
await delay 1s
function timber_test:count_logs {test:"settings_axe_iron_off_no_chop"}
function timber_test:player {name:"axo_iron_t",axe:"minecraft:iron_axe"}
dummy axo_iron_t mine ~20 ~0 ~20
...
function timber_test:assert_only_mined_gone {test:"settings_axe_iron_off_no_chop"}
