#> With the stone axe switched off it doesn't chop
...
await delay 1s
function timber_test:count_logs {test:"settings_axe_stone_off_no_chop"}
function timber_test:player {name:"axo_stone_t",axe:"minecraft:stone_axe"}
dummy axo_stone_t mine ~20 ~0 ~20
...
function timber_test:assert_only_mined_gone {test:"settings_axe_stone_off_no_chop"}
