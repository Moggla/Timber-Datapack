#> With standing off and sneaking on a standing player doesn't chop
...
await delay 1s
function timber_test:count_logs {test:"settings_sneak_only_standing_no_chop"}
function timber_test:player {name:"standoff_t",axe:"minecraft:iron_axe"}
dummy standoff_t mine ~20 ~0 ~20
...
function timber_test:assert_only_mined_gone {test:"settings_sneak_only_standing_no_chop"}
