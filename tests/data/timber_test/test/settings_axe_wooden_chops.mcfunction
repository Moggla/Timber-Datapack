...
await delay 1s
function timber_test:count_d7 {test:"settings_axe_wooden_chops"}
function timber_test:player {name:"ax_wooden_t",axe:"minecraft:wooden_axe"}
dummy ax_wooden_t mine ~20 ~0 ~20
...
function timber_test:assert_no_tree {test:"settings_axe_wooden_chops"}
