#> Mining the bottom log of a 2x2 spruce tree with an axe chops down the whole tree
...
await delay 1s
function timber_test:count_d7 {test:"chop_mega_spruce_tree"}

function timber_test:player {name:"mega_spruce_t",axe:"minecraft:iron_axe"}
function timber_test:mine {name:"mega_spruce_t"}
...
function timber_test:assert_no_logs_warn_leaves {test:"chop_mega_spruce_tree"}
