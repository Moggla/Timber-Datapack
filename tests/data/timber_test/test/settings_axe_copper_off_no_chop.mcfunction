#> With the copper axe switched off it doesn't chop
...
await delay 1s
function timber_test:count_logs {test:"settings_axe_copper_off_no_chop"}
function timber_test:player {name:"axo_copper_t",axe:"minecraft:copper_axe"}
dummy axo_copper_t mine ~20 ~0 ~20
...
function timber_test:assert_only_mined_gone {test:"settings_axe_copper_off_no_chop"}
