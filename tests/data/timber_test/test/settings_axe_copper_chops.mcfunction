#> The copper axe chops a tree by default
...
await delay 1s
function timber_test:count_d7 {test:"settings_axe_copper_chops"}
function timber_test:player {name:"ax_copper_t",axe:"minecraft:copper_axe"}
dummy ax_copper_t mine ~20 ~0 ~20
...
function timber_test:assert_no_tree {test:"settings_axe_copper_chops"}
