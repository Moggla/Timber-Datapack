...
function timber_test:tree {feature:"minecraft:dark_oak"}
assert block ~20 ~ ~20 #minecraft:logs

# let the leaves settle before the tree is chopped
await delay 1s
function timber_test:count_d7 {test:"chop_dark_oak_tree"}

function timber_test:player {name:"dark_oak_t",axe:"minecraft:iron_axe"}
function timber_test:mine {name:"dark_oak_t"}
