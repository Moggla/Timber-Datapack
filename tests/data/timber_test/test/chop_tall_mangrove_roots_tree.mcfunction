...
execute if score #adj_chop_tall_mangrove_roots_tree timber_test >= min_leaves_found timber run function timber_test:assert_no_roots
execute if score #adj_chop_tall_mangrove_roots_tree timber_test >= min_leaves_found timber run function timber_test:assert_no_tree {test:"chop_tall_mangrove_roots_tree"}
