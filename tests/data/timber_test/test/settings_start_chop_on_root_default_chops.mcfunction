...
function timber_test:player {name:"root_start_t",axe:"minecraft:iron_axe"}
dummy root_start_t mine ~21 ~1 ~20
...
function timber_test:assert_no_tree {test:"settings_start_chop_on_root_default_chops"}
