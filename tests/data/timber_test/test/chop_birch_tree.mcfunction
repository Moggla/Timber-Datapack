...
await delay 1s
function timber_test:count_d7 {test:"chop_birch_tree"}

function timber_test:player {name:"birch_t",axe:"minecraft:iron_axe"}
function timber_test:mine {name:"birch_t"}
