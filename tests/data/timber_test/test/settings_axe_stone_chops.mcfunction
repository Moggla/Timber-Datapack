#> The stone axe chops a tree by default
...
await delay 1s
function timber_test:count_d7 {test:"settings_axe_stone_chops"}
function timber_test:player {name:"ax_stone_t",axe:"minecraft:stone_axe"}
dummy ax_stone_t mine ~20 ~0 ~20
...
function timber_test:assert_no_tree {test:"settings_axe_stone_chops"}
