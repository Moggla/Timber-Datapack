#> The golden axe chops a tree by default
...
await delay 1s
function timber_test:count_d7 {test:"settings_axe_golden_chops"}
function timber_test:player {name:"ax_golden_t",axe:"minecraft:golden_axe"}
dummy ax_golden_t mine ~20 ~0 ~20
...
function timber_test:assert_no_tree {test:"settings_axe_golden_chops"}
