...
execute unless score destroy_roots timber = destroy_roots timber run scoreboard players set destroy_roots timber 1
execute unless score start_chop_on_root timber = start_chop_on_root timber run scoreboard players set start_chop_on_root timber 1
