...
execute positioned ~ ~ ~1 unless entity @e[tag=timber_checked,distance=...9,sort=nearest,limit=1] if block ~ ~ ~ #minecraft:leaves[persistent=false] run summon area_effect_cloud ~ ~ ~ {Tags:["timber_checked"],Duration:1}
execute positioned ~ ~ ~-1 unless entity @e[tag=timber_checked,distance=...9,sort=nearest,limit=1] if block ~ ~ ~ #minecraft:leaves[persistent=false] run summon area_effect_cloud ~ ~ ~ {Tags:["timber_checked"],Duration:1}
execute positioned ~1 ~ ~ unless entity @e[tag=timber_checked,distance=...9,sort=nearest,limit=1] if block ~ ~ ~ #minecraft:leaves[persistent=false] run summon area_effect_cloud ~ ~ ~ {Tags:["timber_checked"],Duration:1}
execute positioned ~-1 ~ ~ unless entity @e[tag=timber_checked,distance=...9,sort=nearest,limit=1] if block ~ ~ ~ #minecraft:leaves[persistent=false] run summon area_effect_cloud ~ ~ ~ {Tags:["timber_checked"],Duration:1}
execute positioned ~ ~1 ~ unless entity @e[tag=timber_checked,distance=...9,sort=nearest,limit=1] if block ~ ~ ~ #minecraft:leaves[persistent=false] run summon area_effect_cloud ~ ~ ~ {Tags:["timber_checked"],Duration:1}
