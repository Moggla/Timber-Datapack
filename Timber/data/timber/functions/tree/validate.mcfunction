...
execute as @e[type=minecraft:armor_stand,tag=timber_log,distance=...1,sort=arbitrary,limit=1] if predicate timber:item/log run function timber:tree/algorithm/validate