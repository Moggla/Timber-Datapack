...
execute positioned ~ ~ ~1 unless entity @e[type=minecraft:area_effect_cloud,tag=timber_leaf_distance,distance=...1,sort=arbitrary,limit=1] if predicate timber:block/leaf run function timber:tree/algorithm/leaves/destroy
scoreboard players operation leaf_distance_old timber = @e[type=minecraft:area_effect_cloud,tag=timber_leaf_distance,distance=...1,sort=arbitrary,limit=1] timber
execute positioned ~ ~ ~-1 unless entity @e[type=minecraft:area_effect_cloud,tag=timber_leaf_distance,distance=...1,sort=arbitrary,limit=1] if predicate timber:block/leaf run function timber:tree/algorithm/leaves/destroy
scoreboard players operation leaf_distance_old timber = @e[type=minecraft:area_effect_cloud,tag=timber_leaf_distance,distance=...1,sort=arbitrary,limit=1] timber
execute positioned ~1 ~ ~ unless entity @e[type=minecraft:area_effect_cloud,tag=timber_leaf_distance,distance=...1,sort=arbitrary,limit=1] if predicate timber:block/leaf run function timber:tree/algorithm/leaves/destroy
