...
execute as @e[type=minecraft:item,nbt={OnGround:1b,Item:{id:"biomesoplenty:orange_autumn_sapling"}}] at @s if block ~ ~ ~ minecraft:air if block ~ ~-1 ~ #timber:grow run function timber:plant
execute as @e[type=minecraft:item,nbt={OnGround:1b,Item:{id:"biomesoplenty:maple_sapling"}}] at @s if block ~ ~ ~ minecraft:air if block ~ ~-1 ~ #timber:grow run function timber:plant
execute as @e[type=minecraft:item,nbt={OnGround:1b,Item:{id:"biomesoplenty:fir_sapling"}}] at @s if block ~ ~ ~ minecraft:air if block ~ ~-1 ~ #timber:grow run function timber:plant
execute as @e[type=minecraft:item,nbt={OnGround:1b,Item:{id:"biomesoplenty:redwood_sapling"}}] at @s if block ~ ~ ~ minecraft:air if block ~ ~-1 ~ #timber:grow run function timber:plant
execute as @e[type=minecraft:item,nbt={OnGround:1b,Item:{id:"biomesoplenty:white_cherry_sapling"}}] at @s if block ~ ~ ~ minecraft:air if block ~ ~-1 ~ #timber:grow run function timber:plant
execute as @e[type=minecraft:item,nbt={OnGround:1b,Item:{id:"biomesoplenty:pink_cherry_sapling"}}] at @s if block ~ ~ ~ minecraft:air if block ~ ~-1 ~ #timber:grow run function timber:plant
execute as @e[type=minecraft:item,nbt={OnGround:1b,Item:{id:"biomesoplenty:mahogany_sapling"}}] at @s if block ~ ~ ~ minecraft:air if block ~ ~-1 ~ #timber:grow run function timber:plant
execute as @e[type=minecraft:item,nbt={OnGround:1b,Item:{id:"biomesoplenty:jacaranda_sapling"}}] at @s if block ~ ~ ~ minecraft:air if block ~ ~-1 ~ #timber:grow run function timber:plant
execute as @e[type=minecraft:item,nbt={OnGround:1b,Item:{id:"biomesoplenty:palm_sapling"}}] at @s if block ~ ~ ~ minecraft:air if block ~ ~-1 ~ #timber:grow run function timber:plant
execute as @e[type=minecraft:item,nbt={OnGround:1b,Item:{id:"biomesoplenty:willow_sapling"}}] at @s if block ~ ~ ~ minecraft:air if block ~ ~-1 ~ #timber:grow run function timber:plant
execute as @e[type=minecraft:item,nbt={OnGround:1b,Item:{id:"biomesoplenty:dead_sapling"}}] at @s if block ~ ~ ~ minecraft:air if block ~ ~-1 ~ #timber:grow run function timber:plant
execute as @e[type=minecraft:item,nbt={OnGround:1b,Item:{id:"biomesoplenty:magic_sapling"}}] at @s if block ~ ~ ~ minecraft:air if block ~ ~-1 ~ #timber:grow run function timber:plant
