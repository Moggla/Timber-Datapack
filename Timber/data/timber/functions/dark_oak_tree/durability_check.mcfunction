...
execute unless score stop_chopping timber matches 1.. if score @s t_golden_axe matches 1.. if score durability timber matches ..31 run function timber:dark_oak_tree/chop
execute unless score stop_chopping timber matches 1.. if score @s t_diamond_axe matches 1.. if score durability timber matches ..1560 run function timber:dark_oak_tree/chop