...
execute positioned ~ ~ ~1 unless entity @e[type=minecraft:area_effect_cloud,tag=timber_leaf_distance,distance=...9,sort=arbitrary,limit=1] if block ~ ~ ~ minecraft:dark_oak_leaves[persistent=false] run function timber:dark_oak_tree/leaves_destroy
scoreboard players operation leaf_distance_old timber = @e[type=minecraft:area_effect_cloud,tag=timber_leaf_distance,distance=...9,sort=arbitrary,limit=1] timber
execute positioned ~ ~ ~-1 unless entity @e[type=minecraft:area_effect_cloud,tag=timber_leaf_distance,distance=...9,sort=arbitrary,limit=1] if block ~ ~ ~ minecraft:dark_oak_leaves[persistent=false] run function timber:dark_oak_tree/leaves_destroy
scoreboard players operation leaf_distance_old timber = @e[type=minecraft:area_effect_cloud,tag=timber_leaf_distance,distance=...9,sort=arbitrary,limit=1] timber
execute positioned ~1 ~ ~ unless entity @e[type=minecraft:area_effect_cloud,tag=timber_leaf_distance,distance=...9,sort=arbitrary,limit=1] if block ~ ~ ~ minecraft:dark_oak_leaves[persistent=false] run function timber:dark_oak_tree/leaves_destroy
