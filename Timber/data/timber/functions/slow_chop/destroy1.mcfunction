# api
execute if score destroy_leaves timber matches 1.. at @e[type=minecraft:area_effect_cloud,tag=timber_destroy,sort=nearest,limit=1] run function #timber:api/break_log
# Destroy 1 block
