...
execute positioned ~ ~ ~1 unless entity @e[tag=timber_leaf_distance,distance=...9,sort=arbitrary,limit=1] if block ~ ~ ~ minecraft:jungle_leaves[persistent=false] run function timber:jungle_tree/leaves_destroy
scoreboard players operation leaf_distance_old timber = @e[tag=timber_leaf_distance,distance=...9,sort=arbitrary,limit=1] timber
execute positioned ~ ~ ~-1 unless entity @e[tag=timber_leaf_distance,distance=...9,sort=arbitrary,limit=1] if block ~ ~ ~ minecraft:jungle_leaves[persistent=false] run function timber:jungle_tree/leaves_destroy
scoreboard players operation leaf_distance_old timber = @e[tag=timber_leaf_distance,distance=...9,sort=arbitrary,limit=1] timber
execute positioned ~1 ~ ~ unless entity @e[tag=timber_leaf_distance,distance=...9,sort=arbitrary,limit=1] if block ~ ~ ~ minecraft:jungle_leaves[persistent=false] run function timber:jungle_tree/leaves_destroy
