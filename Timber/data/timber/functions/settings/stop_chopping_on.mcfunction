execute if score wear_out timber matches 1.. run tellraw @s ["",{"text":"Can't be enabled when \"Additionally Wear out Tool Depending on Tree Size\" is disabled.","color":"gold"}]
