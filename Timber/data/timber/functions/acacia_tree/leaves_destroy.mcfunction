...
function timber:acacia_tree/get_leaf_distance
...
execute if score leaf_distance_old timber < leaf_distance timber run function timber:acacia_tree/leaves_search